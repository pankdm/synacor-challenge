>     0| noop
   ...
   2993| add r1 r0 1
   2997| rmem r0 r1
   3000| call 1518  // print_string( * r0 )
   3002| out "\n"
   3004| jmp 3238
   3006| push r0
   3008| push r1
   ...
   3043| add r0 r0 0
   3047| rmem r0 r0
   3050| call 1518  // print_string( * r0 )
   3052| out " ==\n"
   3060| pop r0
   3062| push r0
   3064| add r0 r0 1
   ...
   3097| add r0 r0 r1
   3101| rmem r0 r0
   3104| call 1518  // print_string( * r0 )
   3106| out "\n"
   3108| pop r0
   3110| push r0
   3112| call 5823
   ...
   3351| call 1458  // print "look\n  You may merely 'look' to examine the room, "
   3353| pop r2
   3355| pop r1
   3357| pop r0
   3359| pop r0
   ...
   3835| call 1458  // print "Chiseled on the wall of one of the passageways, yo"
   3837| pop r2
   3839| pop r1
   3841| pop r0
   3843| rmem r0 3726
   ...
   4243| rmem r1 r1
   4246| set r0 26024
   4249| call 1518  // print "As you enter the room, the symbol on the floor bri"
   4251| set r0 r1
   4254| call 1518  // print_string( * r0 )
   4256| set r0 26088
   4259| call 1518  // print ".  The orb begins subtly glowing "
   4261| set r0 r1
   4264| call 1518  // print_string( * r0 )
   4266| out ".\n\n"
   4272| pop r2
   4274| pop r1
   4276| pop r0
   ...
   4314| set r0 r1
   4317| call 1518  // print_string( * r0 )
   4319| set r0 26170
   4322| call 1518  // print ".  The number on the floor vibrates strangely bene"
   4324| pop r0
   4326| set r1 r0
   4329| rmem r0 3952
   4332| rmem r2 3951
   ...
   4586| jt r0 4596
   4589| set r0 26484
   4592| call 1518  // print "  The hourglass has already run out.  It flashes b"
   4594| jmp 4565
   4596| set r0 26584
   4599| call 1518  // print "  The hourglass is still running!  It flashes whit"
   4601| add r0 2716 2
   4605| wmem r0 32767
   4608| pop r0
   4610| ret
   ...
   4650| set r0 26737
   4653| call 1518  // print " the room, the orb evaporates out of your hands!  "
   4655| call 4660
   4657| pop r0
   4659| ret
   4660| push r0
   ...
   4848| call 1458  // print "You fill your lantern with oil.  It seems to cheer"
   4850| pop r2
   4852| pop r1
   4854| pop r0
   4856| jmp 4882
   ...
   4874| call 1458  // print "You'll have to find something to put the oil into "
   4876| pop r2
   4878| pop r1
   4880| pop r0
   4882| pop r0
   ...
   5100| add r2 r0 0
   5104| rmem r0 r2
   5107| call 1518  // print_string( * r0 )
   5109| pop r0
   5111| push r0
   5113| push r0
   5115| push r1
   ...
   5302| call 1458  // print "As you place the last coin, they are all released "
   5304| pop r2
   5306| pop r1
   5308| pop r0
   5310| jmp 5336
   ...
   5328| call 1458  // print "As you place the last coin, you hear a click from "
   5330| pop r2
   5332| pop r1
   5334| pop r0
   5336| pop r3
   ...
   5470| call 1458  // print "A strange, electronic voice is projected into your"
   5472| pop r2
   5474| pop r1
   5476| pop r0
   5478| noop
   ...
   5556| call 1458  // print "\n\nIt begins to rain.  The message washes away.  Yo"
   5558| pop r2
   5560| pop r1
   5562| pop r0
   5564| wmem 2732 2498
   ...
   5595| call 1458  // print "A strange, electronic voice is projected into your"
   5597| pop r2
   5599| pop r1
   5601| pop r0
   5603| jmp 5714
   ...
   5621| call 1458  // print "You activate the teleporter!  As you spiral throug"
   5623| pop r2
   5625| pop r1
   5627| pop r0
   5629| set r0 0
   ...
   5698| call 1458  // print "\n\nAfter a few moments, you find yourself back on s"
   5700| pop r2
   5702| pop r1
   5704| pop r0
   5706| wmem 2732 2488
   ...
   5745| call 1458  // print "You gaze into the mirror, and you see yourself gaz"
   5747| pop r2
   5749| pop r1
   5751| pop r0
   5753| rmem r0 3955
   ...
   5813| ret
   5814| out "- "
   5818| call 1518  // print_string( * r0 )
   5820| out "\n"
   5822| ret
   5823| push r1
   5825| push r2
